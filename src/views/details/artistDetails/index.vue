	...
	<div class="artist">
		...
		<el-tabs v-model="selectedTag" v-loading="isLoading">
			<el-tab-pane label="热门歌曲" name="hotSongs">
				...
				<MusicList :musicArr="songList" :showArName="false" :showLike="true" :like="(id) => likeS(id)" />
			</el-tab-pane>
			<el-tab-pane :label="`专辑 ${artistDetail?.albumSize || ''}`" name="album">
...
import { getArtistAlbum, getArtistMv, getArtistDetail, getArtistTopSong } from '@/api/api';
