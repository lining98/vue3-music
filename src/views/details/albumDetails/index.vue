	...
	<div class="playlist">
		...
		<el-tabs v-model="tab">
			...
			<el-tab-pane label="评论" name="comments">
				<Comment :id="route.query.id" :type="3" :hotComents="hotComents" :newComents="newComents" />
			</el-tab-pane>
			<el-tab-pane label="专辑详情" name="desc">
				<p v-if="albumDetail?.description" style="white-space: pre-wrap" v-html="albumDetail?.description"></p>
